...
class ApplicationEndpointsApi {
  ...
  ///
  /// Get all Connections
  Future<InlineResponse2003> v2ApplicationConnectionsGet(String accessToken, int connectorId, String connectStatus, String connectError, String updateRequestedAt, String updateStatus, String updateError, String lastSuccessfulUpdatedAt, String createdAt, String updatedAt, int limit, int offset, String sort) {
...
if("null" != sort)
  ...
  ///
  /// Get all Credentials
  Future<InlineResponse2004> v2ApplicationCredentialsGet(String accessToken, int connectorId, String attrKey, String attrValue, String createdAt, String updatedAt, int limit, int offset, String sort) {
    Object postBody = null;
    // verify required params are set
    if(    // verify required params are set
    if(    // verify required params are set
...
if("null" != sort)
  ...
  Future<InlineResponse2001> v2ApplicationTrackingRemindersGet(String accessToken, String clientId, String createdAt, String updatedAt, int limit, int offset, String sort) {
    Object postBody = null;
    // verify required params are set
    if(    // verify required params are set
    if(    // verify required params are set
...
if("null" != sort)
  ...
  ///
  /// Get all Updates
  Future<InlineResponse2006> v2ApplicationUpdatesGet(String accessToken, int connectorId, int numberOfMeasurements, bool success, String message, String createdAt, String updatedAt, int limit, int offset, String sort) {
    Object postBody = null;
    // verify required params are set
    if(    // verify required params are set
    if(    // verify required params are set
...
if("null" != sort)
  ...
  ///
  /// Get all VariableUserSources
  Future<InlineResponse2009> v2ApplicationVariableUserSourcesGet(String accessToken, int variableId, int timestamp, int earliestMeasurementTime, int latestMeasurementTime, String createdAt, String updatedAt, int limit, int offset, String sort) {
    Object postBody = null;
    // verify required params are set
    if(    // verify required params are set
    if(    // verify required params are set
...
if("null" != sort)
  ...
  ///
  /// Get all Votes
  Future<InlineResponse20010> v2ApplicationVotesGet(String accessToken, String clientId, int causeId, int effectId, int value, String createdAt, String updatedAt, int limit, int offset, String sort) {
    Object postBody = null;
    // verify required params are set
    if(    // verify required params are set
    if(    // verify required params are set
